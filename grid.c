...
void render_digit_5x3(int x,int y, int digit,int color,unsigned int* pixelbuffer,int zoom)
{
	for(int i=0;i<3;i++)
	{
		for(int j=0;j<5;j++)
...
void render_digits_5x3(int x, int y, const char *text, int color,unsigned int* pixelbuffer,int zoom)
{
	while (*text)
	{
